class InsurancesController < ApplicationController
  ...
  private
    ...
    def insurance_params
      params.require(:insurance).permit(:insurance, :insuranceaddress, :insurancecity, :insurancestate, :insurancezip, :insurancephone, :prrname, :prrphone, :prrext, :prrfax, :prremail, :ncrname, :ncrphone, :nvrext, :ncvrfax, :ncremail, :crname, :crphone, :crext, :crfax, :cremail, :insurancenotes)
    end
end
