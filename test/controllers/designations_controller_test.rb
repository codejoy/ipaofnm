...
class DesignationsControllerTest < ActionController::TestCase
  ...
  test "should create designation" do
    assert_difference('Designation.count') do
      post :create, designation: { amtchangedate: @designation.amtchangedate, designation: @designation.designation, dues: @designation.dues, status: @designation.status }
    end
  ...
  test "should update designation" do
    patch :update, id: @designation, designation: { amtchangedate: @designation.amtchangedate, designation: @designation.designation, dues: @designation.dues, status: @designation.status }
    assert_redirected_to designation_path(assigns(:designation))
  end
